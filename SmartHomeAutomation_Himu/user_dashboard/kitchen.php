                    ...
                    <td width="70%">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                <label class="control-label">LED TEN STATUS</label>
                                <div class="text-right">
                                    ...
                                    <p class="help-block">led number TEN control panel</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-2"></div>
...
if(isset($_POST['led_5_onn'])){
                    echo "led_5_onn";
                    $sqlstring = "UPDATE `component` SET `mode` = '0' WHERE `component`.`id` = 11";
                    $dataquery = mysqli_query( $con,$sqlstring);
                    
                }
                if(isset($_POST['led_5_off'])){
                    echo "led_5_off";
                    $sqlstring = "UPDATE `component` SET `mode` = '1' WHERE `component`.`id` = 11";
                    $dataquery = mysqli_query($con,$sqlstring);
                }
 ?>